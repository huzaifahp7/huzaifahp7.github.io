...
<div align="center">
  <img src="/assets/images/cofiscal1.gif" alt="CoFiscal Dashboard Animation" width="70%" style="border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.12); margin-bottom: 1em;">
  <img src="/assets/images/cofiscal2.png" alt="CoFiscal Model Output" width="60%" style="border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.10); margin-bottom: 1em;">
</div>
